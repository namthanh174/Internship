				...
				<form method="post" id="wpsf-add-post-form" class="live-form">
					...
					echo '<div id="wpsf-add-source-form-container" class="metabox-holder">
						...
						<div id="extract-options" class="postbox">
							...
							<div class="inside">
							<label class="extract-opt" for="js" style="display: inline-block"><input id="js" type="checkbox" name="js" value="1" disabled="disabled">Load JavaScript</label><p class="description">SSome content may need javascript enabled to display correctly. Check this box to enable javascript while selecting content.</p><br>
...
<h3>
<strong>Live Scrape (Available in the Pro Version)</strong>
</h3>
<p>Live scrape provides a shortcode that will automatically refresh scraped content with a recurring cron schedule. This can be used for ratings, reviews, scores, rankings and so much more! Please visit <a href="http://www.wpscraper.com/" target="_blank">wpscraper.com</a> to purchase the Pro Version.<br>
<br>
